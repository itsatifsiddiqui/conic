...
class ContextActionWidget extends StatefulWidget {
  /// Construct a CupertinoContextMenuAction.
  const ContextActionWidget({
    Key? key,
    required this.child,
  ...
  @override
  _ContextActionWidgetState createState() => _ContextActionWidgetState();
}

class _ContextActionWidgetState extends State<ContextActionWidget> {
  static const Color _kBackgroundColor = Color(0xFFEEEEEE);
  static const Color _kBackgroundColorPressed = Color(0xFFDDDDDD);
  static const double _kButtonHeight = 42;
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  if (widget.trailingIcon != null)
                    Icon(
                      widget.trailingIcon,
                      color: _textStyle.color!.withOpacity(0.7),
                      size: 24,
                    ),
                ],
              ),
